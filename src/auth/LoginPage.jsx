...
export default function LoginPage() {
    ...
    return (
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes orbFloat1 { 0%,100% { transform: translateY(0px) rotate(0deg); } 50% { transform: translateY(-16px) rotate(8deg); } }
        @keyframes orbFloat2 { 0%,100% { transform: translateY(0px) rotate(0deg); } 50% { transform: translateY(-20px) rotate(-6deg); } }
        ...
        @keyframes pulseGreen { 0%,100% { box-shadow: 0 0 0 0 rgba(45,138,45,0.4); } 50% { box-shadow: 0 0 0 12px rgba(45,138,45,0); } }
            ...
            <div style={{
                ...
                <div className="panel-left" style={{
                    ...
                    <div style={{
                        ...
                        background: "rgba(74,207,80,0.12)", filter: "blur(60px)",
                    }} />
                    <div style={{
                        position: "absolute", bottom: -60, left: -60,
                        width: 260, height: 260, borderRadius: "50%",
                        background: "rgba(249,115,22,0.08)", filter: "blur(50px)",
                    }} />
