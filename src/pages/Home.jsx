    ...
    return (
        <>
            ...
            <div style={{ position: "relative", zIndex: 1, minHeight: "100vh" }}>
                ...
                {/* ── WhatsApp ── */}
                <a href={`https://wa.me/${import.meta.env.VITE_WHATSAPP_NUMBER || "2348078168804"}`} target="_blank" rel="noreferrer" style={{ position: "fixed", bottom: 28, left: 28, zIndex: 700, background: "#25D366", borderRadius: 50, padding: "10px 18px", display: "flex", alignItems: "center", gap: 8, boxShadow: "0 4px 16px rgba(37,211,102,0.35)", color: "white", fontWeight: 700, fontSize: 13, fontFamily: "'DM Sans',sans-serif", textDecoration: "none" }}>
